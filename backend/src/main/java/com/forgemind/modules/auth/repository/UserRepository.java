 ...
 * <ul>
 *   <li>Login: look up by {@code email} (primary login field)</li>
 *   <li>JWT filter: look up by {@code username} (stored as JWT subject)</li>
 *   <li>Registration guard: existence checks by email and username</li>
 * </ul>
 */
@Repository
public interface UserRepository extends JpaRepository<User, Long> {
     ...
     * Used by {@link org.springframework.security.core.userdetails.UserDetailsService}
     ...
     * Used during login when the client supplies an email instead of username.
     *
