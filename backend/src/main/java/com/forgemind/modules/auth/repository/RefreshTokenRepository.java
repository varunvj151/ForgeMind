 ...
 * <ul>
 *   <li>Lookup token by hash for validation during token refresh</li>
 *   <li>Revoke all tokens for a user on logout</li>
 *   <li>Purge expired tokens (scheduled maintenance)</li>
 * </ul>
 */
@Repository
public interface RefreshTokenRepository extends JpaRepository<RefreshToken, Long> {
     ...
     * Used during the refresh-token flow to validate the supplied token.
     *
    ...
    /**
     * Returns all refresh tokens owned by a given user.
     * Useful for listing or bulk-revoking a user's sessions.
     *
    ...
    /**
     * Revokes (soft-deletes) all non-revoked tokens belonging to the given user.
     ...
     * Intended to be called by a scheduled maintenance job.
     *
