 ...
 *
 * <p>In normal application flow, roles are read-only (seeded by Flyway). This repository is used
 * during user registration to look up role records by their authority string name.
 */
@Repository
