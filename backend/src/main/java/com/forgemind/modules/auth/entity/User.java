 ...
 * without a separate adapter class. This keeps the auth pipeline lean.
 *
...
public class User implements UserDetails {
    ...
    /**
     * Roles assigned to this user. Fetched eagerly so that Spring Security
     * can build the {@link GrantedAuthority} list without an open Session.
     */
     ...
     * Spring Security uses this to verify credentials via {@link org.springframework.security.crypto.password.PasswordEncoder}.
     */
    @Override
