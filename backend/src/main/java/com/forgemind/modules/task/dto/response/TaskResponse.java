...
public record TaskResponse(
    ...
    Instant updatedAt) {
  /**
   * Minimal user summary embedded in a task response. Avoids pulling in the full UserResponse with
   * role arrays.
   */
  public record AssigneeInfo(Long id, String username, String firstName, String lastName) {}
}
