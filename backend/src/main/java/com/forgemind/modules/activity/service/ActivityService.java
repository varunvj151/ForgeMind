...
public interface ActivityService {
  ...
  /**
   * Retrieves the activity timeline for a project. Caller must be verified as the project owner
   * before invoking.
   */
  Page<ActivityResponse> getProjectActivities(UUID projectId, Pageable pageable);

  /**
   * Retrieves the activity timeline for a team. Caller must be verified as a team member before
   * invoking.
   */
