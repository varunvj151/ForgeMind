...
public class RealTimeEventPublisher {
    ...
    public void publish(Activity activity) {
        try {
            ...
            RealTimeEvent.ActorInfo actorInfo = new RealTimeEvent.ActorInfo(
            ...
            log.error("Failed to broadcast real-time event for activity {}: {}", activity.getId(), e.getMessage());
        }
    }
    ...
    private UUID deriveEntityId(Activity activity, String entityType) {
        switch (entityType) {
            case "PROJECT": return activity.getProjectId();
            case "TASK": return activity.getTaskId();
            case "TEAM": return activity.getTeamId();
            default: return null;
        }
    }
