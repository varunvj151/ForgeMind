 ...
 *
 * <ul>
 *   <li>Docker Compose {@code healthcheck} directives
 *   <li>GitHub Actions CI pipeline smoke test
 *   <li>Future Kubernetes liveness/readiness probes
 * </ul>
 *
 * <p>For deeper health information (database connectivity, Redis ping), use the Spring Boot
 * Actuator endpoint at {@code GET /actuator/health}.
 */
@Slf4j
@RestController
