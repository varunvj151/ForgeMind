 ...
 *
 * <p>MapStruct generates the implementation at compile time as a Spring {@code @Component}.
 * All three mapping directions are covered:
 * <ul>
 *   <li>Entity → Response DTO</li>
 *   <li>Request DTO → new Entity</li>
 *   <li>Request DTO → existing Entity (partial update via {@code @MappingTarget})</li>
 * </ul>
 */
...
public interface ProjectMapper {
     ...
     * Server-managed fields are intentionally ignored.
     */
    ...
    /**
     * Applies changes from a ProjectRequest onto an existing managed Project entity.
     * Server-managed fields are intentionally ignored so they are never overwritten.
     */
    @Mapping(target = "id", ignore = true)
    @Mapping(target = "createdAt", ignore = true)
    @Mapping(target = "updatedAt", ignore = true)
