 ...
 *
 * <p>Spring Data JPA generates the implementation automatically.
 * Additional query methods are added here as the module grows.
 */
@Repository
public interface ProjectRepository extends JpaRepository<Project, UUID> {
     ...
     * Useful for dashboard views and filtered lists.
     */
