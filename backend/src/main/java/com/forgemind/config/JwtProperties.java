 ...
 *
 * <p>Validated at startup so that a missing or blank secret causes a descriptive startup failure
 * rather than a cryptic signature error at runtime.
 *
 * <pre>
 * app:
 *   jwt:
...
public class JwtProperties {
  ...
  /**
   * HS256 signing secret. Must be at least 256 bits (32 ASCII characters) for HS256. Override via
   * {@code JWT_SECRET} environment variable in production.
   */
  ...
  @Min(
      value = 60_000,
      message = "app.jwt.refresh-expiration-ms must be at least 60,000 ms (1 minute)")
