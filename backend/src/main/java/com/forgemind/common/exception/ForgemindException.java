 ...
 *
 * <p>Every module-specific exception (e.g., {@code ProjectNotFoundException}, {@code
 * InvalidCredentialsException}) should extend this class, providing its own {@link HttpStatus} and
 * error {@code code} string.
 *
 * <p>The {@link GlobalExceptionHandler} catches this exception type and maps it to a consistent
 * {@link com.forgemind.common.dto.ErrorResponse} structure.
 */
@Getter
